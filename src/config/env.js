...
module.exports = {
  ...
  rechargeKitRcVerifyUrl: process.env.RECHARGEKIT_RC_VERIFY_URL || 'https://verify.rechargkit.biz/validation/rcAdvanceVerify',
  rechargeKitAuthToken: process.env.RECHARGEKIT_AUTH_TOKEN || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJtZW1iZXJJZCI6MzIxLCJpYXQiOjE3ODM2MTQ1NzN9.H3wnI0sx28UIqLVQWjxkXyxTsKjfuwhTt7EF7CMShZQ',
  rechargeKitRequestTimeoutMs: Number(process.env.RECHARGEKIT_REQUEST_TIMEOUT_MS || 10000),
